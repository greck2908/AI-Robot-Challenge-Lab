...
from botbuilder.schema import (Activity, Activrm -rf ~/ros_ws && sed -i '$ d' ~/.bashrc && cd ~/AI-Robot-Challenge-Lab && source devel/setup.bash && roslaunch sorting_demo sorting_demo.launchityTypes)
